			...
			<table class="bbsListTbl" summary="번호,제목,조회수,작성일 등을 제공하는 표">
				...
				<tbody>
					<c:forEach var="notice" items="${list}">
						<tr>
							<td>${notice.no}</td>
							<td class="tit_notice"><a href="/noticeView?no=${notice.no}">${notice.title}</a></td>
							<td>${notice.count}</td>
