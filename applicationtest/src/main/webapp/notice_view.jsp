	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">			
			<ul class="bbsview_list">
				...
				<li class="bbs_title">${view.title}</li>

				<li class="bbs_hit">작성일 : <span>${view.create_date}</span></li>
				<li class="bbs_date">조회수 : <span>${view.count}</span></li>
			...
			<input type="hidden" name="no" value="${view.no}" readonly>
