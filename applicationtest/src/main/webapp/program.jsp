...
<div id="wrap">
	...
	<header id="header">
		<div class="header_area box_inner clear">	
			<h1><a href="/index">Tourist in tour</a></h1>
	...
	<div id="container">
		...
		<div class="bodytext_area place_area box_inner">
			...
			<ul class="program_list clear">
				<c:forEach var="programList" items="${programs}">
					<li>
						<img class="img_place" src="img/${programList.img}" alt="${programList.title}" />
						<h3>${programList.title}</h3>

						<p class="subttl">${programList.schedule}</p>
						<div class="program_content">
							<p>${programList.text}<span class="subtxt">${subrtext}</span></p>
						</div>
						<p class="btn_more"><a href="javascript:;">더보기</a>
							<a href="/Cookie?title=${programList.title}">저장</a></p>
					</li>
				</c:forEach>
					<ul class="program_list clear">
				<li>
					...
					<p class="btn_more2"><a href="javascript:;">저장</a></p>
				</li>
					</ul>
<%--				<li>--%>
